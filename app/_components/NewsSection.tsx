    ...
    return (
        <section id="news" className="max-w-full mx-auto max-h-[37rem] flex flex-row flex-nowrap items-center justify-between">
            ...
            <div className="w-full md:w-[75%] flex flex-row justify-between">
                {/* Imagens */}
                <div className="flex flex-row gap-4 items-center justify-center max-w-full -ml-[7rem]">
                    {/* Imagem 1 */}
                ...
                {/* noticia */}
                <div className="flex flex-col w-full md:w-auto items-end justify-end gap-4 h-full px-[5rem]">
                    {/* imagem noticia */}
                    <div className="min-w-[20rem] min-h-[10rem]">
                        <Image src="/News-Header.jpg" alt="imagem da noticia" width={1000} height={1000} className="object-contain h-auto w-auto rounded-[4rem] max-w-[23rem] max-h-[13rem] -mt-[10rem]" />

                    </div>
                    {/* noticia */}
                    <div className="flex flex-col w-full items-start px-8 gap-4 mb-4">
                        <h3 className="text-xl font-bold">04 de Março &apos;25</h3>
                        <h2 className="text-4xl font-bold">A terapia é uma excelente ferramenta para combater a ansiedade, afirma estudos.</h2>
                        <p className="text-lg">Depois da pandemia de 2021, com o aumento do home-office, a terapia tem sido uma porta de escape para muitas pessoas na atualidade.</p>
